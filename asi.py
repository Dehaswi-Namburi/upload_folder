...
def update_financial_year_options(selected_classification_year, selected_indicator, selected_state):
    if not selected_classification_year or not selected_indicator or not selected_state:
        # If not all dropdowns are selected, return empty options
        return []

    # Filter the DataFrame based on the selected classification year
    filtered_df = df[
...
def update_plot(n_clicks_plot, n_clicks_graph, selected_indicator, selected_state,selected_classification_year,selected_financial_years):
    ...
    if button_id == "plot-button":
        if n_clicks_plot == 0 or not (selected_indicator and selected_state and selected_classification_year):
            return dash.no_update, "", {'display': 'none'}, selected_indicator, selected_state,selected_classification_year, selected_financial_years
        ...
        if not filtered_df.empty:
            ...
            return fig, "", {'display': 'block'}, selected_indicator, selected_state,selected_classification_year,selected_financial_years
        else:
            return dash.no_update, "This combination does not exist. Please try another combination.", {'display': 'none'}, selected_indicator, selected_state,selected_classification_year,selected_financial_years
    ...
    #         info_style['display'] = 'none'
        ...
        #info_style['display'] = 'none'
        return dash.no_update, "", dash.no_update, selected_indicator, selected_state,selected_classification_year, selected_financial_years
